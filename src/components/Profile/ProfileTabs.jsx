...
const ProfileTabs = () => {
    return (
        <Flex w={"full"} justifyContent={"center"} gap={{ base: 4, sm: 10 }} textTransform={"uppercase"} fontWeight={"bold"}>
            <Flex borderTop={"1px solid white"} alignItems={"center"} p={3} gap={2} cursor={"pointer"}>   {/* p{1.2}*/}
                <Box fontSize={20} ><BsGrid3X3 /></Box>
                <Text fontSize={12} display={{ base: "none", sm: "block" }}>Post</Text>
            </Flex>
            <Flex _after={{ borderTop: "1px solid white" }} alignItems={"center"} p={3} gap={2} cursor={"pointer"}>
